...
WORKING_DIR=/home/emrosky/mW_Potential/Reproduce_T_melt_273K/Analysis_Scripts
...
gnuplot -e "set terminal svg background rgb 'white'; \
            set title 'Potential Energy - Ice Eq at 273K'; \
            set ylabel 'kJ/mol'; \
            set xlabel 'Time (ns)'; \
            set key outside ; \
            set key right top ; \
            set style data lines; \
            plot for [i=268:274] 'run_Tmelt_'.i.'K_AUTO.dat' using 1:7 title ''.i.'K' " > ${WORKING_DIR}/Tmelt_PE_all.svg

# Plot and save Total Energy
gnuplot -e "set terminal svg background rgb 'white'; \
            set title 'Total Energy - Ice Eq at 273K'; \
            set ylabel 'kJ/mol'; \
            set xlabel 'Time (ns)'; \
            set key outside ; \
            set key right top ; \
            set style data lines; \
            plot for [i=268:274] 'run_Tmelt_'.i.'K_AUTO.dat' using 1:5 title ''.i.'K'" > ${WORKING_DIR}/Tmelt_TE_all.svg

# Plot and save Mean square disp
gnuplot -e "set terminal svg background rgb 'white'; \
            set title 'Mean Square Displacement - Ice Eq at 273K'; \
            set ylabel 'Angstroms'; \
            set xlabel 'Time (ns)'; \
            set key outside ; \
            set key right top ; \
            set style data lines; \
            plot for [i=268:274] 'run_Tmelt_'.i.'K_AUTO.dat' using 1:8 title ''.i.'K'" > ${WORKING_DIR}/Tmelt_MSD_all.svg

# Plot and save Volume
gnuplot -e "set terminal svg background rgb 'white'; \
            set title 'Box Volume - Ice Eq at 273K'; \
            set ylabel 'Cubic Angstroms'; \
            set xlabel 'Time (ns)'; \
            set key outside ; \
            set key right top ; \
            set style data lines; \
            plot for [i=268:274] 'run_Tmelt_'.i.'K_AUTO.dat' using 1:4 title ''.i.'K'" > ${WORKING_DIR}/Tmelt_VOL_all.svg
