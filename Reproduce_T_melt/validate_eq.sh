...
datafile="setup_atoms_280K_01.eq_water"
...
gnuplot -e "set terminal svg background rgb 'white'; \
            set title 'Potential Energy - Water 280K'; \
            set ylabel 'kcal/mol'; \
            set xlabel 'timestep'; \
            set style data lines; \
            plot '${datafile}.dat' using 1:7" > water_eq_PE.svg
...
gnuplot -e "set terminal svg background rgb 'white'; \
            ...
            set xlabel 'timestep'; \
            set style data lines; \
            plot '${datafile}.dat' using 1:8" > water_eq_MSD.svg
