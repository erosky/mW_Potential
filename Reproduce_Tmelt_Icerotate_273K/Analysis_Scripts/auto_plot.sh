...
gnuplot -e "set terminal svg background rgb 'white'; \
            set title 'Potential Energy - Rotated Ice Eq at 273K'; \
            set ylabel 'kJ/mol'; \
            set xlabel 'Time (ns)'; \
            set key outside ; \
            set key right top ; \
...
gnuplot -e "set terminal svg background rgb 'white'; \
            set title 'Total Energy - Rotated Ice Eq at 273K'; \
            set ylabel 'kJ/mol'; \
            set xlabel 'Time (ns)'; \
            set key outside ; \
            set key right top ; \
...
gnuplot -e "set terminal svg background rgb 'white'; \
            set title 'Mean Square Displacement - Rotated Ice Eq at 273K'; \
...
gnuplot -e "set terminal svg background rgb 'white'; \
            set title 'Box Volume - Rotated Ice Eq at 273K'; \
