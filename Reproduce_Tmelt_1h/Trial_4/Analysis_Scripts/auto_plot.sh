...
WORKING_DIR=~/mW_Potential/Reproduce_Tmelt_1h/Trial_3/Analysis_Scripts
...
gnuplot -e "set terminal svg background rgb 'white'; \
            ...
            plot for [i=268:275] 'run_Tmelt_'.i.'K_AUTO.dat' using 1:7 title ''.i.'K' " > ${WORKING_DIR}/Tmelt_PE_all.svg
...
gnuplot -e "set terminal svg background rgb 'white'; \
            ...
            set key right top ; \
            set style data lines; \
            plot for [i=268:275] 'run_Tmelt_'.i.'K_AUTO.dat' using 1:5 title ''.i.'K'" > ${WORKING_DIR}/Tmelt_TE_all.svg
...
gnuplot -e "set terminal svg background rgb 'white'; \
            ...
            set key right top ; \
            set style data lines; \
            plot for [i=268:275] 'run_Tmelt_'.i.'K_AUTO.dat' using 1:8 title ''.i.'K'" > ${WORKING_DIR}/Tmelt_MSD_all.svg
...
gnuplot -e "set terminal svg background rgb 'white'; \
            ...
            set key right top ; \
            set style data lines; \
            plot for [i=268:275] 'run_Tmelt_'.i.'K_AUTO.dat' using 1:4 title ''.i.'K'" > ${WORKING_DIR}/Tmelt_VOL_all.svg
