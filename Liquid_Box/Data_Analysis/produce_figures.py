...
log_file = "no_thermostat_200K_01.dat"
...
plt.grid(True)
plt.savefig('density_200K_no_thermostat.png', bbox_inches='tight')
plt.show()
...
plt.grid(True)
plt.savefig('energy_200K_no_thermostat.png', bbox_inches='tight')
plt.show()
...
plt.grid(True)
plt.xlabel('Time (ns)')
plt.savefig('enthalpy_200K_no_thermostat.png', bbox_inches='tight')
plt.show()
