...
# USE: python produce_figures.py DATA_FILE OUTPUT_LABEL
...
plt.grid(True)
figname = 'figures/density_' + output_label + '.png'
...
plt.grid(True)
figname = 'figures/energy_' + output_label + '.png'
plt.savefig(figname, bbox_inches='tight')
plt.show()
...
plt.grid(True)
plt.xlabel('Time (ns)')
figname = 'figures/enthalpy_' + output_label + '.png'
plt.savefig(figname, bbox_inches='tight')
plt.show()
...
# plt.hlines(273.15, 0, 10, colors='r', label="273.15 K")
figname = 'figures/diffusion_' + output_label + '.png'
plt.savefig(figname, bbox_inches='tight')
plt.show()
